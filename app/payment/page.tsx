...
export default function PaymentPage() {
  ...
  useEffect(() => {
    // Load cart data
    getCartData().then(setCartData).catch(console.error);
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full py-4 px-4 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white font-semibold rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-emerald-600/25 active:scale-[0.98] flex items-center justify-center gap-2"
            >
              {isProcessing ? (
                <>
